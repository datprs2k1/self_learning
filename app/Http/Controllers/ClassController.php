...
class ClassController extends Controller
{
    ...
    {
        //
        $data = ClassModel::with('department', 'subject', 'student', 'lesson', 'question')->orderBy('id', 'desc')->get();
    ...
    {
        //
        $class = ClassModel::with('department', 'subject', 'student', 'lesson', 'question')->find($id);
