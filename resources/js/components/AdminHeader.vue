          ...
          >
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <router-link :to="{ name: 'document.add' }" class="nav-link">
                    <i class="ml-1 mr-1 nav-icon fas fa-plus-circle"></i>
                    <p>Thêm</p>
                  </router-link>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <router-link :to="{ name: 'test.index' }" class="nav-link">
                    <i class="ml-1 mr-1 nav-icon fas fa-table"></i>
                    <p>Danh sách</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link :to="{ name: 'test.add' }" class="nav-link">
                    <i class="ml-1 mr-1 nav-icon fas fa-plus-circle"></i>
                    <p>Thêm</p>
                  </router-link>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <router-link :to="{ name: 'question.add' }" class="nav-link">
                    <i class="ml-1 mr-1 nav-icon fas fa-plus-circle"></i>
                    <p>Thêm</p>
                  </router-link>
                </li>
