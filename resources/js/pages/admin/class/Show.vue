                      ...
                      >
                        <template #head(checkbox)="">
                          <b-form-checkbox
                            ...
                            v-model="studentotp.allSelected"
                            v-b-tooltip.hover.v-secondary
                            title="Chọn tất cả"
                          ></b-form-checkbox>
                        </template>
