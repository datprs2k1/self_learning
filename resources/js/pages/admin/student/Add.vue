                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="class">Tên lớp</label>
                        <multiselect v-model="student.class_id" :class="{ 'is-invalid': errors.class_id }" selectLabel="Nhấn enter hoặc click để chọn" selectedLabel="Đang được chọn" noOptions="Trống" deselectLabel="Nhấn enter hoặc click để bỏ chọn" :options="CLASS" placeholder="Chọn lớp" label="name" track-by="name"></multiselect>
                      <span
