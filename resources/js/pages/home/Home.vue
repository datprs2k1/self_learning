          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
                <h2 class="slideshow">HỆ THỐNG QUẢN LÝ VIỆC TỰ HỌC</h2>
                <p class="slideshow">UTT - SELFLEARNING</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              ...
              <img src="images/laptop.jpg" width="240px" />
            </div>
            <div class="col-lg-8">
              <p class="lead mt-5">
...
import LecturerComponent from "../lecturer/Index";
export default {
  data() {
    return {
      user: null,
