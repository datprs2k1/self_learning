...
<div>
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="images/logo-utt.png" alt="AdminLTELogo" height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="images/logo-utt.png" alt="UTT Logo" class="brand-image img-circle elevation-3" style="opacity: .9">
